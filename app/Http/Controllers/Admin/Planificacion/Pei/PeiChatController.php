...
class PeiChatController extends Controller
{
    ...
    {
        // Administradores, Coordinadores, Analistas, Gestores y Colaboradores de Actividades tienen acceso
        if ($user->hasAnyRole([
            'Administrador',
            'Super Admin',
    ...
    public function getMessages(Request $request, $peiProfileId)
    {
        ...
        $messages = $query->get()->map(function ($msg) use ($user) {
            ...
            return [
                ...
                'origin_module' => $msg->origin_module,
                'origin_title' => $msg->origin_title,
                'origin_url' => $msg->origin_url,
