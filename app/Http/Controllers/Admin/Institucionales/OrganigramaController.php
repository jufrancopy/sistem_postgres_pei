...
namespace App\Http\Controllers\Admin\Institucionales;

use Illuminate\Http\Request;
use App\Http\Controllers\Controller;

use App\Admin\Institucionales\Organigrama;
...
class OrganigramaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.institucionales.organigramas.organigrama', get_defined_vars());
    }
    ...
    public function listaOrganigramas(){
        ...
        return view('admin.institucionales.organigramas.index', get_defined_vars())
    ...
    public function crearSubDependencia(Request $request, $idDependencia)
    {
        ...
        return view('admin.institucionales.organigramas.crear_sub_dependencia', get_defined_vars());
    ...
    public function editarSubDependencia(Request $request, $idDependencia)
    {
        ...
        return view('admin.institucionales.organigramas.editar_sub_dependencia', get_defined_vars());
    ...
    public function create(Request $request)
    {
        ...
        return view('admin.institucionales.organigramas.create', get_defined_vars());
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.institucionales.organigramas.show', get_defined_vars());
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.institucionales.organigramas.edit', get_defined_vars());
    }
