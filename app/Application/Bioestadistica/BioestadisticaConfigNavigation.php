...
class BioestadisticaConfigNavigation
{
    ...
    public static function tabs(): array
    {
        return [
            ...
            [
                'label' => 'Deptos. y servicios',
                'route' => 'bioestadistica.estructura.index',
                'permission' => 'bio.geo.view',
                'active' => ['bioestadistica.estructura.*'],
            ],
            [
    ...
    public static function tabIsActive(array $tab): bool
    {
        ...
        $prefixes = match ($tab['route']) {
            ...
            'bioestadistica.estructura.index' => ['bioestadistica/estructura'],
