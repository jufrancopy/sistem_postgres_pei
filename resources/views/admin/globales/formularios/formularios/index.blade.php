                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-primary btn-circle"
                                                    href="{{ route('globales.formularios.edit', $formulario->id) }}"><i
                                                        class="far fa-edit"></i></a>
                                                {!! Form::open([
                                                    'route' => ['globales.formularios.destroy', $formulario->id],
                                                    'method' => 'DELETE',
                                                    'style' => 'display:inline',
                                                ]) !!}
                                                <button class="btn btn-danger btn-circle"
                                                    onclick="return confirm('Estas seguro de eliminar el rol {{ $formulario->formulario }}. Si lo eliminas también eliminarás los datos asociados a el.')">
                                                    <i class="fa fa-trash"></i>
                                                </button>
                                                {!! Form::close() !!}
                                                <a class="btn btn-info btn-circle"
                                                    href="{{ route('globales.formularios.show', $formulario->id) }}"><i
