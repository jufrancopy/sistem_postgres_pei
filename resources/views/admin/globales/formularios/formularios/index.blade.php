        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-header card-header-info">
                    ...
                    <a class="btn btn-success" href="{{ route('formulario-formularios.create') }}">Nuevo Formulario</a>
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary btn-circle" href="{{ route('formulario-formularios.edit',$formulario->id) }}"><i class="far fa-edit"></i></a>
                                        {!! Form::open(['route' => ['formulario-formularios.destroy', $formulario->id], 'method' => 'DELETE', 'style'=>'display:inline']) !!}
                                        ...
                                        <a class="btn btn-info btn-circle" href="{{ route('formulario-formularios.show',$formulario->id) }}"><i class="far fa-eye"></i></a>
