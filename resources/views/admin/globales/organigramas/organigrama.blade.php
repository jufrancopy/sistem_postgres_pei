                    ...
                    <div class="card">
                        <div class="card-header card-header-info">
                            ...
                            <a class="btn btn-warning"
                                href="{{ route('globales.organigramas.show', $dependencia->id) }}">Ver
                                Organigrama</a>
                            <a class="btn btn-secondary"
                                href="{{ route('globales.organigramas.edit', $dependencia->id) }}">Editar</a>
                            ...
                            <ul>
                                @foreach ($dependencia->children as $depth1)
                                    <li>{{ $depth1->dependency }}
                                        ...
                                        {!! Form::open([
                                            'route' => ['globales.organigramas.destroy', $depth1->id],
                                            'method' => 'DELETE',
                                    ...
                                    <ul>
                                        @foreach ($depth1->children as $childDependency)
                                            @include('admin.globales.organigramas.child_dependency', [
                                                'child_dependency' => $childDependency,
                                            ])
                                        @endforeach
                                    </ul>
                                @endforeach
