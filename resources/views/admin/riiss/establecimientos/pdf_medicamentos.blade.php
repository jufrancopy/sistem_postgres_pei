...
<body>
    <div class="footer">
        Instituto de Previsión Social (IPS) — Red Integrada e Integral de Servicios de Salud (RIISS) | Reporte Técnico Oficial emitido el {{ $fecha }}
    </div>
    ...
    <table class="header-table">
        <tr>
            <td style="width: 70%;">
                ...
                <div class="doc-title">Cartera de Medicamentos y Suministros por Especialidad</div>
            </td>
            <td style="width: 30%; text-align: right;">
                ...
                <div style="font-size: 8.5px; color: #0284c7; font-weight: bold; margin-top: 2px;">DOCUMENTO TÉCNICO</div>
            </td>
        </tr>
    </table>
        ...
        <tr>
            ...
            <td style="width: 50%; padding-left: 6px;">
                <div class="kpi-card green">
                    <div class="kpi-num">{{ $totalMedicamentos }}</div>
                    <div class="kpi-label">Total Medicamentos en Catálogo</div>
                </div>
            </td>
        </tr>
    </table>
