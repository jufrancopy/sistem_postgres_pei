...
@section('title', 'Crear Estrategias DO')
@section('content')
    <div class="content">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-info">
                            <h4 class="card-title ">Crear Estrategias DO</b>
                        </div>
                        @if (count($errors) > 0)
                            ...
                            <ol class="breadcrumb mb-0">
                                @if (isset($profile))
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Estrategias
                                        DO: {{ $profile->name }}</li>
                                @else
                                    <li class="breadcrumb-item active" aria-current="page">Estrategias DO</li>
                                @endif
                            </ol>
                        </nav>
                        ...
                        <div class="card-body">
                            ...
                            <div class="content">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                                    <button type="submit" class="btn btn-success">Crear Estrategia DO</button>
                                </div>
                            </div>
                            {!! Form::close() !!}
