                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-info">
                            <h4 class="card-title ">Aspectos de la Categoría {{ $categoria->name }}</b></h4>
                        ...
                        <div class="card-body">
                            {!! Form::open(['route' => 'foda-analisis.store', 'method' => 'POST', 'name' => 'f1']) !!}
                            <div class="content">
                        ...
                        @else
                            <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                                <button type="submit" class="btn btn-success"><a
                                        href="{{ route('foda-analisis-ambiente-externo', $idPerfil) }}">Sin
                                        Aspectos</a></button>
                            </div>
                            @endif
