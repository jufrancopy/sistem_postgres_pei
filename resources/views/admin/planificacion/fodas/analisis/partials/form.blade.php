...
<div class="form-group">
    ...
    {{ Form::select('ocurrencia', ['0.10' => 'Baja', '0.30' => 'Media', '0.50' => 'Alta', '0.70' => 'Muy Alta', '0.90' => 'Cierta'], null, ['class' => 'form-control', 'placeholder' => 'Seleccione una opcion']) }}
</div>

<div class="form-group">
    {{ Form::label('impacto', 'Nivel de Impacto') }}
    {{ Form::select('impacto', ['0.05' => 'Muy Bajo', '0.10' => 'Bajo', '0.20' => 'Moderado', '0.40' => 'Alto', '0.80' => 'Muy Alto'], null, ['class' => 'form-control', 'placeholder' => 'Seleccione una opcion']) }}
</div>
