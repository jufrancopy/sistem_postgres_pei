    ...
    <script>
        var data = [
            @foreach ($analisis as $valor)
                {
                    name: '{{ $valor->aspecto->name }}' + '@switch($valor->tipo) @case('Fortaleza') <p class = "badge badge-success" > Fortaleza </p>'+ '@break' +
                    ...
                    children: [{
                        ...
                        @switch ($total)
                            ...
                            @case($total <= 0.17)
                            '<td><strong class="badge badge-danger">Insifuciente({{ $total }})<strong/></td>' +
                            @break
