            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header card-header-info">
                        <h4 class="card-title ">Categorias del modelo {{$modelo->nombre}}</h4>
                        @can('role-create')
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('foda-modelo-categoria-aspectos',['idModelo'=>$categoria->modelo_id, 'idCategoria'=>$categoria->id])}}">
                                                <span class="btn btn-success btn-circle">{{App\Admin\Planificacion\Foda\FodaAspecto::where('categoria_id', $categoria->id)->count()}}</span>
                                            </a>
