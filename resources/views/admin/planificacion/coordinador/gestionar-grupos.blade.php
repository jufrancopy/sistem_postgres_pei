...
@section('title', 'Gestionar Grupos y Usuarios')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-info">
                        <h4 class="card-title">Gestionar Grupos y Usuarios</h4>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="alert alert-info">
                                    ...
                                    <strong>Información:</strong> Aquí puede gestionar los grupos y usuarios asociados al PEI de su grupo padre.
                                </div>
                            </div>
                        </div>
