        ...
        <div class="modal-content border-0 shadow-lg rounded-lg overflow-hidden">
            ...
            <div class="modal-header bg-dark text-white py-3 px-4 d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center" style="gap: 10px;">
                    <span class="badge badge-warning font-weight-bold px-2 py-1" style="font-size: .75rem; letter-spacing: .04em;">
                        <i class="fa fa-sort-amount-asc mr-1"></i> DRAG & DROP
                    </span>
                    <h5 class="modal-title font-weight-bold text-white mb-0" id="modalReordenarPeiLabel" style="font-size: 1.05rem;">
                        Reordenar Estructura PEI: <span class="text-warning">{{ strip_tags($master->name) }}</span>
                    </h5>
                </div>
            ...
            <div class="modal-body p-4 bg-light">
                ...
                <div class="d-flex align-items-center flex-wrap mb-3 px-2" style="gap: 8px; font-size: 0.72rem;">
                    <span class="text-muted font-weight-bold mr-1">Niveles del Plan:</span>
                    <span class="badge badge-primary"><i class="fa fa-layer-group mr-1"></i>Ejes</span>
                    <span class="badge badge-info"><i class="fa fa-bullseye mr-1"></i>Obj. Estratégicos</span>
                    <span class="badge badge-warning text-dark"><i class="fa fa-crosshairs mr-1"></i>Obj. Específicos</span>
                    <span class="badge badge-purple text-white" style="background:#7e22ce;"><i class="fa fa-bolt mr-1"></i>Acc. Estratégicas</span>
                    <span class="badge badge-success"><i class="fa fa-tasks mr-1"></i>Acc. Operativas</span>
                </div>

                {{-- Árbol Draggable --}}
                <div class="card border shadow-xs rounded-lg overflow-hidden">
                    <div class="card-header bg-white py-2 px-3 border-bottom d-flex align-items-center justify-content-between">
                        <span class="font-weight-bold text-dark" style="font-size: .83rem;">
                        ...
                        <div style="gap: 4px;" class="d-flex align-items-center">
                            <button type="button" class="btn btn-xs btn-outline-secondary py-0 px-2" id="btnExpandirTodoTreePei">
                                <i class="fa fa-plus-square mr-1"></i> Expandir Todo
                            </button>
                            <button type="button" class="btn btn-xs btn-outline-secondary py-0 px-2" id="btnColapsarTodoTreePei">
                                <i class="fa fa-minus-square mr-1"></i> Colapsar Todo
                            </button>
                        </div>
                    </div>
                    <div class="card-body p-3 bg-white" id="contenedorArbolDraggablePei" style="max-height: 520px; overflow-y: auto;">
                        @if(isset($tree) && $tree->children->isNotEmpty())
