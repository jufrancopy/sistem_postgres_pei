                    ...
                    <div class="card-header bg-light" id="headingAxi_{{ $axi->id }}">
                        <h5 class="mb-0" id="axisBlock_{{ $axi->id }}">
                            <div class="d-flex justify-content-between">
                                ...
                                <a class="btn btn-success btn-circle" data-id="{{ $axi->id }}" data-type="edit"
                                    href="javascript:void(0)" id="createAxis"><i class="fa fa-edit"
                                        aria-hidden="true"></i></a>
                                <a class="btn btn-info btn-circle createGoalsButton" data-id="{{ $axi->id }}"
                                    ...
                                    <div class="card-header" id="headingGoal_{{ $goal->id }}">
                                        <h5 class="mb-0">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <a class="btn btn-success btn-circle" data-id="{{ $goal->id }}"
                                                    data-type="edit" href="javascript:void(0)" id="createGoals"><i
                                                        class="fa fa-edit" aria-hidden="true"></i></a>
                                                <a class="btn btn-info btn-circle createActionsButton"
