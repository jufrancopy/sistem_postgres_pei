                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-success btn-circle"
                                                        href="{{ route('peis-perfiles.edit', $perfil->id) }}"><i
                                                            class="far fa-edit"></i></a>
                                                    {!! Form::open([
                                                        'route' => ['peis-perfiles.destroy', $perfil->id],
                                                        'method' => 'DELETE',
                                                        'style' => 'display:inline',
                                                    ]) !!}
                                                    <button class="btn btn-danger btn-circle"
                                                        onclick="return confirm('Estas seguro de eliminar el perfil {{ $perfil->nombre }}. Si lo eliminas también eliminarás los datos asociados a el.')">
                                                        <i class="fa fa-trash" aria-hidden="true"></i>
                                                    </button>
                                                    {!! Form::close() !!}
                                                    <a class="btn btn-warning btn-circle"
                                                        href="{{ route('peis-perfiles.show', $perfil->id) }}"><i
                                                            class="fa fa-cog" aria-hidden="true"></i>
                                                        </i></a>
                                                    <a class="btn btn-info btn-circle"
                                                        href="{{ route('ver-cuadro-mando', $perfil->id) }}"><i
