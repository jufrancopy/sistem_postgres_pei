            ...
            <div class="form-row align-items-end">
                ...
                <div class="col-md-12 mb-2">
                    @include('admin.bioestadistica.captura._organo-corte-select', [
                        ...
                        'wrapperClass' => 'mb-0',
                        'labelClass' => 'small text-muted mb-1',
                        'corteRequired' => $cortesPeriodo->isNotEmpty(),
                        'alwaysEnabled' => true,
                        'helpText' => 'Busque el nombre de la dependencia (departamento, servicio o sección).',
                    ])
                </div>
                <div class="col-md-12 mb-0">
                    <button class="btn btn-primary btn-sm" type="submit">Aplicar</button>
                    <small class="text-muted d-block mt-2">{{ $periodHelp ?? 'Al aplicarlo se recarga el formulario.' }}</small>
