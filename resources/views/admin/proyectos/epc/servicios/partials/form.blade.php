        ...
        $(document).ready(function() {
            var addEquipamientoCantidad = function(data) {
                var $divRow = $('<div>').addClass('row')
                    .css({
                        marginTop: '4px'
                    }).appendTo('#equipamientoCantidadFields');
            ...
            var addInfraestructuraCantidad = function(data) {
                var $divRow = $('<div>').addClass('row')
                    .css({
                        marginTop: '4px'
                    }).appendTo('#infraestructuraCantidadFields');

                var marginTopBtn = {
                    marginTop: 0
                };
                var $infraestructura = $('<select>').addClass('form-control infraestructura-field')
                ...
                addSelect2($infraestructura, 'infraestructuras', '/infraestructuras/get',
            ...
            var addOtroServicioCantidad = function(data) {
                var $divRow = $('<div>').addClass('row')
                    .css({
                        marginTop: '4px'
                    }).appendTo('#otroServicioCantidadFields');

                var marginTopBtn = {
                    marginTop: 0
                };
                var $otroServicio = $('<select>').addClass('form-control otroServicio-field')
            ...
            $(window).on("load", function() {
                ...
                var infraestructuraCantidad = $('[data-infraestructura-cantidad]').data(
                    'infraestructuraCantidad');
                $(infraestructuraCantidad).each(function(index, data) {
                    addInfraestructuraCantidad(data);
                })

                var apoyoAdministrativoCantidad = $('[data-apoyo-administrativo-cantidad]').data(
                    'apoyoAdministrativoCantidad');
