                    ...
                    <div class="card">
                        <div class="card-header card-header-info">
                            ...
                            <div class="pull-left">
                                <a class="btn btn-success"
                                    href="{{ route('proyectos-epc-servicios.edit', $servicio->id) }}">
                                    Editar</a>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <table class="table">
                                    @php
                                        $totalGeneral = $totalEquipamiento + $totalTalentoHumano + $totalInfraestructura + $totalApoyoAdministrativo + $totalOtroServicio;
                                    @endphp
