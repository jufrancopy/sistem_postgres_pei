...
Route::post('/riiss/portal-validador/{token}/firmar-establecimiento', [\App\Http\Controllers\Admin\Riiss\ValidacionEspecialidadesController::class, 'firmarEstablecimiento'])->name('riiss.portal-validador.firmar-establecimiento');
Route::post('/riiss/portal-validador/{token}/reabrir-establecimiento', [\App\Http\Controllers\Admin\Riiss\ValidacionEspecialidadesController::class, 'reabrirEstablecimiento'])->name('riiss.portal-validador.reabrir-establecimiento');
Route::get('/riiss/portal-validador/{token}/acta-establecimiento/{establecimiento_id}', [\App\Http\Controllers\Admin\Riiss\ValidacionEspecialidadesController::class, 'actaEstablecimientoImprimir'])->name('riiss.portal-validador.acta-establecimiento');
Route::get('/riiss/portal-validador/{token}/acta-establecimiento-pdf/{establecimiento_id}', [\App\Http\Controllers\Admin\Riiss\ValidacionEspecialidadesController::class, 'actaEstablecimientoPdf'])->name('riiss.portal-validador.acta-establecimiento-pdf');
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::prefix('riiss')->name('riiss.')->middleware(['role:Administrador|Super Admin|Analista - RIISS|Analista RIISS|Coordinador RIISS|Coordinador - RIISS|Coordinación RIISS'])->group(function () {
        ...
        Route::put('validaciones-especialidades/enlace/{id}', [\App\Http\Controllers\Admin\Riiss\ValidacionEspecialidadesController::class, 'actualizarEnlace'])
            ->name('validaciones.actualizar-enlace');
        ...
        Route::put('validaciones-farmaceuticas/enlace/{id}', [\App\Http\Controllers\Admin\Riiss\ValidacionEspecialidadesController::class, 'actualizarEnlaceFarmaceutico'])
            ->name('validaciones.farmaceuticas.actualizar-enlace');
        ...
        Route::post('evaluaciones/{evaluacion}/fotos', [\App\Http\Controllers\Admin\Riiss\EvaluacionController::class, 'subirFoto'])
            ->name('evaluaciones.fotos.store');
        Route::delete('evaluaciones/{evaluacion}/fotos/{fotoId}', [\App\Http\Controllers\Admin\Riiss\EvaluacionController::class, 'eliminarFoto'])
            ->name('evaluaciones.fotos.destroy');
        Route::patch('evaluaciones/{evaluacion}/fotos/{fotoId}/descripcion', [\App\Http\Controllers\Admin\Riiss\EvaluacionController::class, 'actualizarDescripcionFoto'])
            ->name('evaluaciones.fotos.descripcion');
